...
namespace ZQF
{
	...
	public:
		...
		ZxMem(const std::string_view msPath, size_t nLoadSize = ZXMEM_AUTO_READ_SIZE);
	...
	public:
		...
		auto Load(const std::string_view msPath, size_t nSize = ZXMEM_AUTO_READ_SIZE) -> ZxMem&;
	};
